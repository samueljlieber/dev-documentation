...
.. note::
   :guilabel:`Product Variants` has to be enabled under :menuselection:`Configuration --> Settings`,
...
addition of a **product configurator** on the product page. The customer is able to configure and
...
.. tip::
   Specific combinations of values can be excluded from the product configurator. The customers are
   then not able to select the excluded combination of values. To do so, access the
